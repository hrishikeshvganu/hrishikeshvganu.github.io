...
***  Real world ranking needs to be efficient: inference latency, training cost \& sample efficiency matter
Of the the three consideratios, in most Internet companies latency matters the most. Each 100ms in latency costs hard dollars.
